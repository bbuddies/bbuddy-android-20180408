...
import com.odde.bbuddy.budget.api.RawBudgetApi;
...
public class ApiModule {
    ...
    @Provides
    @Singleton
    public BudgetApi provideBudget(ApiFactory apiFactory) {
        return new BudgetApi(apiFactory.create(RawBudgetApi.class));
    }
}
